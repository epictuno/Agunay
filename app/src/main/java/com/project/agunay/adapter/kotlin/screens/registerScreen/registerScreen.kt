...
fun BodyContent(
    ...
    Column(
        ...
        RegistrationScreen(viewModel = userViewModel, currentUser = currentUser)
    }
}

@Composable
fun RegistrationScreen(viewModel: registerScreenVM, currentUser: CurrentUser) {
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        ...
        Spacer(modifier = Modifier.height(16.dp)) // Espacio entre el input y el botón

        WalkQuizSquareButtonWithIcon(
            onClick = {
                // Aquí puedes agregar la lógica para crear el usuario o cualquier otra acción
                           },
